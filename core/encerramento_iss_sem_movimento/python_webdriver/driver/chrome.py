...
class ChromeDriver:
    ...
    def type(
        ...
        Args:
            ...
            max_retries: Número máximo de tentativas em caso de falha. Padrão é 60.
    ...
    def clear(
        self, element: WebDriverElement, max_retries: int = 60, timeout: float = 1
    ):
